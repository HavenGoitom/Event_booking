...
async function ProperDataArrangement(FrontEndSentInfo){
    ...
    const payload = {
      ...
      notifyUrl : process.env.NOTIFY_URL,// link where the arif pay server will send the webhook's response obj 
      ...
      expireDate ,
      items : SentItems  ,// the backend will prepare an array of item objects to send to the server
      lang : 'EN' ,
      beneficiaries : [
          {
...
app.post('/paymentProcess' ,  arifPayFunction(req , res));
// front end info 
